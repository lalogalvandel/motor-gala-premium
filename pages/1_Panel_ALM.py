...
with col_activos:
    st.markdown(f"""
    <div style='padding: 1.5rem 1.75rem 0.5rem; background: rgba(68,136,255,0.02); border: 0.5px solid rgba(68,136,255,0.15); border-radius: 6px; margin-bottom: 0.75rem; height: 100%;'>
        <div style='display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.6rem;'>
        ...
        <div style='border-top: 0.5px solid rgba(68,136,255,0.15); margin-top: 1rem; padding-top: 0.5rem;'></div>
    </div>
    """, unsafe_allow_html=True)
    
    vol_cartera = st.slider(
        "Volatilidad Anual del Portafolio (Parámetro CUSF)",
        min_value=0.0, max_value=0.30, value=0.08, step=0.01, format="%.2f",
        key="vol_cartera_slider",
...
if df_pasivos is not None and df_activos is not None:
    try:
        ...
        st.markdown("""
        <div style='margin-bottom: 1.75rem;'>
            <div style='font-family: "DM Mono", monospace; font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; color: #5A6780; margin-bottom: 0.4rem;'>Paso 2 — Validación Regulatoria</div>
        ...
        # Dividimos en 4 columnas para agregar el RCS
        ...
        <div style='margin-bottom: 1rem;'>
            <div style='font-family: "DM Mono", monospace; font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; color: #FF4B4B; margin-bottom: 0.4rem;'>Stress Test — Solvencia II</div>
            <div style='font-family: "EB Garamond", Georgia, serif; font-size: 24px; color: #E8EDF5; font-weight: 400; margin-bottom: 0.5rem;'>Shock en Curva de Tasas</div>
            <div style='font-family: "EB Garamond", Georgia, serif; font-size: 15px; font-style: italic; color: #5A6780; line-height: 1.6;'>Desplace el control para simular un escenario adverso de política monetaria.</div>
        </div>
        """, unsafe_allow_html=True)
        ...
        if shock_bps != 0:
            ...
            st.markdown(f"""
            <div style='display: inline-block; margin-top: 0.25rem; padding: 0.3rem 0.75rem; background: rgba(68,136,255,0.05); border: 0.5px solid rgba(68,136,255,0.15); border-radius: 3px; font-family: "DM Mono", monospace; font-size: 11px; color: {color_shock}; letter-spacing: 0.06em;'>
                Escenario activo &nbsp;·&nbsp; {signo}{shock_bps} bps
            </div>
            """, unsafe_allow_html=True)
        ...
        if ejecutar:
            with st.spinner("Modelando escenarios y calculando calce óptimo..."):
                ...
                if resultado["exito"]:
                    ...
                    st.markdown("""
                    <div style='margin-bottom: 1.75rem;'>
                        <div style='font-family: "DM Mono", monospace; font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; color: #17C37B; margin-bottom: 0.4rem;'>Paso 3 — Reestructuración</div>
